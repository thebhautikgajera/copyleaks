    ...
    <nav className="flex justify-between items-center p-4 bg-transparent shadow-md relative z-50">
      ...
      {isMobile ? (
        ...
        <div className="flex items-center space-x-6">
          ...
          <Link href="/login" passHref>
            <button className="text-[1.3vw] px-8 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-lg shadow-lg hover:shadow-blue-500/30 hover:scale-105 transition-all duration-300 transform active:scale-95 font-semibold">Login</button>
          </Link>
          <Link href="/register" passHref>
            <button className="text-[1.3vw] px-8 py-2.5 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-lg shadow-lg hover:shadow-green-500/30 hover:scale-105 transition-all duration-300 transform active:scale-95 font-semibold">Sign Up</button>
          </Link>
        </div>
      )}
    </nav>
