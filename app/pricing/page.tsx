...
const PricingPage: React.FC = () => {
  ...
  return (
    <div
      className="min-h-screen w-full text-white bg-gradient-to-br from-purple-900 via-indigo-900 to-blue-900"
      id="bgPage1"
    >
      <Navbar />
      <motion.div
          ...
          >
            {plans.map((plan, index) => (
              ...
              >
                ...
                <motion.button
                  className={`w-full bg-gradient-to-r ${plan.color} text-white py-4 px-6 rounded-full text-lg font-semibold hover:shadow-lg transition duration-300`}
